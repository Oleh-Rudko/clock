    ...
    <div className="countdown-container">
      ...
      <div className="countdown-timer">
        <div className="countdown-segment">
          ...
          <span className="countdown-label">{getUkrainianTimeForm(timeRemaining.days, dayForms)}</span>
        </div>
        <div className="countdown-segment">
          <span className="countdown-value">{timeRemaining.hours}</span>
          <span className="countdown-label">{getUkrainianTimeForm(timeRemaining.hours, hourForms)}</span>
        </div>
        <div className="countdown-segment">
          <span className="countdown-value">{timeRemaining.minutes}</span>
          <span className="countdown-label">{getUkrainianTimeForm(timeRemaining.minutes, minuteForms)}</span>
        </div>
        <div className="countdown-segment">
